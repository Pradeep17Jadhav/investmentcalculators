...
const aboutUsData = {
  ...
  mission:
    "At MoneyReload, our mission is to empower individuals to take charge of their financial future by providing easy-to-use and reliable tools to estimate investment returns and assist in their savings and investment journey. We believe that financial literacy is the first step toward making informed decisions, and our platform is dedicated to making such tools accessible to everyone.",
  vision:
    "To be a trusted platform that simplifies financial calculations and inspires individuals to start their journey towards financial security, fostering a culture of financial literacy worldwide.",
  disclaimer:
