...
This clearly shows that **starting early and staying invested for the long term** can generate significant wealth. You can use our [SIP Calculator](/sip-calculator) for calculating the possible profit in mutual funds.
